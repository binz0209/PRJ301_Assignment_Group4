...
public class Email {
    ...
    public String messageNewOrder(String name, int sl, double total) {
        return "<!DOCTYPE html>\n"
                ...
                + "                                    <h1 style=\" font-size:24px;\n"
                + "                                        color:#e67e22;\n"
                + "                                        margin:30px 0;\">ĐƠN HÀNG THÀNH CÔNG</h1>\n"
                + "                                    <p style=\"margin:5px 0 0\">Chào " + name + ",</p>\n"
                + "                                    <p style=\"margin:5px 0 0\">Bạn đã đặt " + sl + " sản phẩm tại ClothesShop. </p>\n"
                + "                                    <p style=\"margin:5px 0 0\">Tổng giá trị đơn hàng: <b>" + total + "</b>. </p>\n"
                + "                                    <p style=\"margin:5px 0 0\">Cảm ơn bạn đã mua sắm tại cửa hàng của chúng tôi. </p>\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                            <tr class=\"contact\" style=\"font-size:11px; color:#999;\">\n"
                + "                                <td align=\"center\"> \n"
    ...
    public String messageSubscribe() {
        return "<!DOCTYPE html>\n"
                ...
                + "                                    <h1 style=\" font-size:24px;\n"
                + "                                        color:#e67e22;\n"
                + "                                        margin:30px 0;\">ĐĂNG KÍ THÀNH CÔNG</h1>\n"
                + "                                    <p style=\"margin:5px 0 0\">Chúc mừng bạn đã đăng kí nhận thông báo của chúng tôi. </p>\n"
                + "                                    <p style=\"margin:5px 0 0\">Chúng tôi sẽ gửi thông tin khuyến mãi, giảm giá sớm nhất tới bạn. </p>\n"
                + "                                    <p style=\"margin:5px 0 0\">Xin cảm ơn. </p>\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                            <tr class=\"contact\" style=\"font-size:11px; color:#999;\">\n"
    ...
    public String messageForgotPass(String code) {
        return "<!DOCTYPE html>\n"
                + "<html>\n"
                + "    <head>\n"
                + "        <title>Email Contact</title>\n"
                ...
                + "                                    <h1 style=\" font-size:24px;\n"
                + "                                        color:#e67e22;\n"
                + "                                        margin:30px 0;\">QUÊN MẬT KHẨU</h1>\n"
                + "                                    <p style=\"margin:5px 0 0\">Bạn vừa gửi yêu cầu lấy lại mật khẩu. </p>\n"
                + "                                    <p style=\"margin:5px 0 0\">Mã code của bạn là <b>" + code + "</b>. </p>\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                            <tr class=\"contact\" style=\"font-size:11px; color:#999;\">\n"
                + "                                <td align=\"center\"> \n"
                + "                                    YonShop 2Hand - 0123 456 789 - yonshop@gmail.com\n"
                + "                                </td>\n"
                + "                            </tr>\n"
                + "                        </table>\n"
                + "                    </div> \n"

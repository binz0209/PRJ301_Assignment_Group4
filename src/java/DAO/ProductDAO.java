        ...
        try {
            ...
            if (conn != null) {
                ...
                while (rs.next()) {
                    ...
                    TypeDTO type = (TypeDTO) tDao.getTypeById(rs.getInt("typeid"));
                    ...
                    ProductDTO product = new ProductDTO(id, productname, description, stock, unitSold, images, colors, sizes, date, discount, price, status, category, type);
        ...
        try {
            ...
            if (con != null) {
                ...
                if (rs.next()) {
                    ...
                    String images[] = rs.getString("images").split(" ");
                    String sizes[] = rs.getString("size").split(",");
                    product = new ProductDTO(id, productname, description, stock, unitSold, images, colors, sizes, date, discount, price, status, category, type);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            if (con != null) {
                ...
                while (rs.next()) {
                    ...
                    String productname = rs.getString("productname");
                    CategoryDTO category = cDao.getCategoryById(rs.getInt("categoryid"));
                    TypeDTO type = (TypeDTO) tDao.getTypeById(typeId);
                    int id = rs.getInt("id");
                    int stock = rs.getInt("stock");
                    String description = rs.getString("description");
                    Date date = rs.getDate("releasedate");
